...
const Blog = ({blog, handleBookmarkButton, handleMarkAsReadButton}) => {
  ...
  return (
      ...
      <button className="text-xl text-[#6047EC] font-semibold underline" onClick={() => handleMarkAsReadButton(reading_time, id)}>Mark as read</button>
    </div>
